...
No local setup is required to evaluate the system. Review credentials are provided separately as supplementary material (not committed to this public repository); contact the authors if you need access.
...
3. On the sign-in screen, enter your review credentials (see above).
...
1. Navigate to **[https://apex-vsp-ja6y.onrender.com/](https://apex-vsp-ja6y.onrender.com/)** and sign in with your review credentials (see above).
